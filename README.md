...
- 　**ライセンス:** 本ソースコードは、オープンソースになりました。複製、修正、改変は自由に行えます。
...
2.  **コマンドの送信**
    ...
    -   実際には、このファイルを介してClaude Desktop 内で動作する[Claude Mcp サーバー Fusion MCP Server for Claude Desktop](<https://github.com/tomo1230/claude_fusion_mcp_server>)とリアルタイム連携して動作します。
